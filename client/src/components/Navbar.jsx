...
const Navbar = () => {
  ...
  return (
    <div className='bg-slate-50 flex justify-center px-4 pt-6'>
        ...
        className='w-full max-w-5xl bg-white/80 rounded-3xl backdrop-blur-xl shadow-sm border border-slate-200 px-8 py-4 flex justify-between items-center relative'>
            <div className='flex items-center gap-3 cursor-pointer'>
                <div className='bg-black text-white p-2 rounded-lg'>
                    <BsRobot size={18}/>

                </div>
                <h1 className='font-semibold hidden md:block text-lg'>ElevateIQ</h1>
            </div>
